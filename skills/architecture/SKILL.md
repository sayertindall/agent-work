...
Before choosing a model, validation boundary, or alternative, use the [principle index](../steady/references/principle-index.md) and read the matching design sections. Revisit them if implementation evidence changes the decision.
